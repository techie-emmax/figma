...
const Fetching = () => {
  ...
  <span className="grid grid-cols-3 grid-rows-2 mt-10 gap-10 p-10">
    ...
    {comments.map((comment) => {
        const nameParts = comment.user.fullName.split(' ');
        ...
        <div className="">
          <img src="src/assets/Frame 15.png" alt="" />
            ...
            <div className="flex  items-center gap-5">  
              <p className="flex bg-gray-400 rounded-full font-display font-regular text-[25px] w-23 h-23 items-center justify-center">{firstInitial}{lastInitial}</p>
